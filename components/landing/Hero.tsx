          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-2xl">
                Credit Tractor helps you track credit card payments, manage payment plans, 
                and visualize your financial progress with powerful analytics and multi-currency support.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-semibold text-gray-900">Credit Tractor</span>
                  </div>
