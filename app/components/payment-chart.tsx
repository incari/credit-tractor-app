    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(totalAmount, userSettings.currency)}</div>
            <p className="text-xs text-muted-foreground">{t.includingInterest}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{formatCurrency(totalPaid, userSettings.currency)}</div>
